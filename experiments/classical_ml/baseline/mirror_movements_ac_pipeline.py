...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--outdir", default="results_ac", help="Cartella di output.")
...
def build_models(random_state: int = 42, knn_k: int = 5, rf_n_estimators: int = 200) -> Dict[str, Pipeline]:
    return {
        "knn": Pipeline([
...
def main() -> None:
    ...
    models = build_models(random_state=args.random_state, knn_k=args.knn_k, rf_n_estimators=args.rf_n_estimators)
