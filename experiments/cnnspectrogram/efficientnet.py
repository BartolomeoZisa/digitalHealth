...
param_grid = {
    'cnn__module__architecture': ['C1', 'C3'],
    'cnn__module__dropout_rate': [0.3, 0.5], # Test different dropout levels
    'cnn__optimizer__weight_decay': [1e-4, 1e-2], # Test different L2 strengths
