...
LOG_DIR="$PROJECT_ROOT/logs/tradional/$TIMESTAMP"
...
# ========================================================
{
    ...
    declare -a scripts=(
        "experiments/k_means/k_means_preprocessed.py"
        "experiments/k_means/k_means_ac_no_preprocessed.py"
        "experiments/k_medoids/k_medoids_ac_no_preprocessed.py"
        "experiments/k_medoids/k_medoids_no_preprocessed.py"
        "experiments/boss/boss_preprocessed.py"
    )
